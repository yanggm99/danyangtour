...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>" style="font-size: 32px; font-weight: 900; color: #222; text-decoration: none; display: flex; align-items: center; gap: 8px;">
                <span style="color: #007bff;"><i class="fa fa-paper-plane" aria-hidden="true"></i></span> 더단양
            </a>
        </div>
